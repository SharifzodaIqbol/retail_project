...
class _ImportProductsScreenState extends State<ImportProductsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // SafeArea защищает контент от перекрытия системными кнопками (снизу) и "челками" (сверху)
      body: SafeArea(
        child: ListView(
          // Добавлен динамический отступ снизу, чтобы при полном скролле контент не прилипал к краю
          padding: EdgeInsets.fromLTRB(
            16,
            16,
            16,
            MediaQuery.of(context).padding.bottom +
                32, // Защита + визульный отступ
          ),
          children: [
            Container(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Маҳсулоти нав сохта шуд: ${_result!['created'] ?? 0}',
                    ),
                    Text(
                      'Маҳсулотҳои тағйир ёфта: ${_result!['updated'] ?? 0}',
                    ),
